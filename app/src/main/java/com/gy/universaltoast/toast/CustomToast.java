package com.gy.universaltoast.toast;
...
import com.gy.universaltoast.R;

import static android.os.Build.VERSION_CODES.JELLY_BEAN;
import static android.os.Build.VERSION_CODES.JELLY_BEAN_MR1;
import static com.gy.universaltoast.toast.UniversalToast.CLICKABLE;
import static com.gy.universaltoast.toast.UniversalToast.EMPHASIZE;
import static com.gy.universaltoast.toast.UniversalToast.UNIVERSAL;
...
public class CustomToast implements IToast {
    ...
    private CustomToast(@NonNull Context context, @NonNull String text, @UniversalToast.Duration int duration, @UniversalToast.Type int type) {
        mType = type;
    ...
    public static CustomToast makeText(@NonNull Context context, @NonNull String text, @UniversalToast.Duration int duration) {
        return makeText(context, text, duration, UNIVERSAL);
    }

    public static CustomToast makeText(@NonNull Context context, @NonNull String text, @UniversalToast.Duration int duration, @UniversalToast.Type int type) {
